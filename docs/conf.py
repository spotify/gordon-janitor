...
release = find_version('../gordon_janitor/__init__.py')
...
htmlhelp_basename = 'gordonjanitordoc'
...
man_pages = [
    (master_doc, 'gordon-janitor', u'gordon-janitor Documentation',
     [author], 1)
]
